...
from dataset.cpc import build_cpc
...
def get_args_parser():
    ...
    parser.add_argument('--dataset_root', default='',
                        help='Root directory of the CPC dataset')
    parser.add_argument('--retrieval_cache_dir', default='',
                        help='Directory with precomputed CPC retrieval tables (.pt files from '
                             'calculate_retrieval_relationships/)')
